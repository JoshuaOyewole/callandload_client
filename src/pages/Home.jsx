...
import icon from "../assets/images/gas-station2.png";

function Homepage() {
  return (
    <>
      <div className={`home-bg bg-cover bg-no-repeat md:bg-center  flex justify-center items-center text-[#151515] flex-col gap-y-10 lg:pb-20 relative `}>
        {/* NAVBAR */}
        <Navbar />

        <div className="container w-[95%] lg:w-[90%] xl:w-[90%] my-0 mx-auto flex flex-col lg:flex-row gap-x-8 items-center mt-10 lg:mt-0">
          <div className="w-[95%] md:w-4/5 lg:w-2/5 bg-white rounded-lg shadow dark:border md:mt-0  dark:bg-gray-800 dark:border-gray-700 order-2 lg:order-1 mt-12 mb-20 lg:mb-0 lg:mt-0 z-10">
            <OrderForm />
          </div>
          {/*  <LoginForm /> */}
          <div className="right w-full  order-1 lg:order-2  lg:w-3/5 lg:h-full flex flex-col justify-center items-center md:min-h-96 z-10">
            <section className=" dark:bg-gray-900">
              <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                <Link
                  ...
                  role="alert"
                >
                  <span className="text-xs bg-primary-600 font-bold rounded-full text-[#df6412ce] px-4 py-1.5 mr-3">
                    New
                  </span>{" "}
                  <span className="text-sm font-medium">
                    A subsidary of MADSAN
                  </span>
                  <svg
                ...
                <h1 className="font-roboto mb-4 text-2xl font-extrabold tracking-tight leading-8 text-white md:text-5xl lg:text-5xl dark:text-white md:leading-[3rem]">
                  Simplify Marine Diesel Procurement with Ease!
                </h1>
                <p className="mb-8 text-lg font-normal text-white lg:text-xl  dark:text-gray-400">
                  Select from trusted suppliers, complete the form, and generate
                  your invoice seamlessly.
                </p>
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                  <Link
                    to="#"
                    className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 hover:underline hover:text-[#ff9900]"
                  >
                    Learn more
                    <svg
                  ...
                  <Link
                    to="#"
                    className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center bg-black text-white rounded-lg border  hover:bg-transparent hover:outline-red-600 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                  >
                    <svg
                ...
                <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg hidden">
                  <span className="font-semibold text-white uppercase">
                    TRUSTED BY
                  </span>
                  <div className="flex flex-wrap justify-center items-center mt-8 text-red-900 sm:justify-between">
                    <Link
                      to="#"
            ...
            <div className="cta font-bold gap-x-6 mb-8 text-white  hidden">
              <p>
                <span style={{ color: "#ff9900" }}>★</span> Quality Driven
              </p>
              <p>
                <span style={{ color: "#ff9900" }}>★</span> Customer Focused{" "}
              </p>
              <p>
                {" "}
                <span style={{ color: "#ff9900" }}>★</span> Global Sourcing
              </p>
            </div>
            <h1 className="font-bold text-3xl text-white text-center md:text-4xl xl:text-[2.7rem] leading-3rem hidden">
              Simplify Your Diesel Procurement Process with Effortless Ordering!
            </h1>
            <p className="mt-5 font-medium text-white text-center hidden">
              Select from trusted suppliers, complete the form, and generate
              your invoice seamlessly.
            </p>
            <div className="card-wrapper mt-20 hidden">
              <div className="cards_container flex-col lg:flex-row flex gap-y-10 lg:gap-x-10 mt-6">
                <div className="card bg-white rounded-xl p-3 w-full lg:w-1/2 flex gap-x-4 text-sm">
                  <div className="icon flex justify-center items-center">
                    <img src={icon} alt={"icon"} height={60} width={60} />
                  </div>
                  <div className="content">
                    <h4 className="font-bold pb-2 text-base">
                      Next Day Delivery
                    </h4>
                    <p>
                      At Madsan Call & Load, 92% of our orders are successfully
                ...
                <div className="card bg-white rounded-xl p-3 w-full lg:w-1/2 flex gap-x-4 text-sm">
                  ...
                  <div className="content">
                    <h4 className="font-bold pb-2 text-base">Low Prices</h4>
                    <p>
                      Our aim is to buy fuel at the lowest price possible and
                      pass the savings on to you.
                    </p>
                  </div>
                </div>
              </div>
              <div className="cards_container flex flex-col lg:flex-row gap-y-10  lg:gap-x-10 mt-6">
                <div className="card bg-white rounded-xl p-3 w-full lg:w-1/2 flex gap-x-4 text-sm">
                  <div className="icon flex justify-center items-center">
                    <img src={icon} alt={"icon"} height={60} width={60} />
                  </div>
                  <div className="content">
                    ...
                    <p>
                      We will assign you an account manager who will be your
                      point of contact from day one.
                    </p>
                  </div>
                </div>
                <div className="card bg-white rounded-xl p-3 w-full lg:w-1/2 flex gap-x-4 text-sm">
        ...
        <div className="bg-overlay h-full lg:h-[110%]"></div>
      </div>
      <Footer />
    </>
  );
