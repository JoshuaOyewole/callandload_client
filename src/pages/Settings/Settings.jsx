        ...
        <div className="w-full px-6 py-6 mx-auto">
          <section className={`${!isLoading && "bg-white"} dark:bg-gray-900`}>
            {isLoading ? (
              ...
              <div className="max-w-6xl px-4 py-8 mx-auto lg:py-16">
                <form action="#">
                  <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    {/*   <div>
                  <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">State</label>
              ...
              <div>
                  <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">LGA</label>
                  <select id="category" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                      <option selected="">Electronics</option>
                      <option value="TV">TV/Monitors</option>
                      <option value="PC">PC</option>
                    ...
                    <div className="sm:col-span-2">
                      <h3 className="text-gray-900 font-bold">Payment Info</h3>
                      <div className="grid gap-4 my-4 sm:grid-cols-3">
                        <div className="w-full">
                          <label
                            htmlFor="bankName"
                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    ...
                    <div className="sm:col-span-2">
                      ...
                      {userInfo.states?.map((state) => {
                        return (
                          <>
                            <h3 className="font-bold">{state.name}</h3>
                            {state.addresses.map((add) => {
                              return <p className="text-sm">- {add.name}</p>;
                            })}
                          </>
                        );
                      })}
